...
Version  : 0.63
Release  : 15
URL      : https://cpan.metacpan.org/authors/id/N/NE/NEELY/Data-Serializer-0.63.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/N/NE/NEELY/Data-Serializer-0.63.tar.gz
...
%prep
%setup -q -n Data-Serializer-0.63
cd %{_builddir}
tar xf %{_sourcedir}/libdata-serializer-perl_0.60-2.debian.tar.xz
cd %{_builddir}/Data-Serializer-0.63
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Data-Serializer-0.63/deblicense/
...
cp %{_builddir}/Data-Serializer-0.63/deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-Data-Serializer/7f76ad22b4b668eaf9159ac6396a33fd70180bfd
if test -f Makefile.PL; then
