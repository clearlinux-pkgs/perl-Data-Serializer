...
cd %{_builddir}/Data-Serializer-0.60
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Data-Serializer-0.60/deblicense/
...
cp %{_builddir}/Data-Serializer-0.60/deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-Data-Serializer/7f76ad22b4b668eaf9159ac6396a33fd70180bfd
if test -f Makefile.PL; then
